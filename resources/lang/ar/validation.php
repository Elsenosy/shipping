...
return [
	...
	'custom'          => [
		...
		'work_years' => [
			'required'     => 'عدد سنوات الخدمه مطلوبة',
			'numeruc'     => 'عدد سنوات الخدمه تدخل أرقام باللغة الإنجليزية',
		],
		'retire_age' => [
			'required'     => 'سنة التقاعد مطلوبة',
			'numeric'     => 'سنة التقاعد تدخل رقمياً باللغه الإنجليزيه',
		],
		'work_place' => [
