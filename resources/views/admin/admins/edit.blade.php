    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                <!--begin::Title-->
                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">تعديل مشرف</h5>
                <!--end::Title-->
                <!--begin::Separator-->
                            ...
                            <div class="card-body p-0">
                                <div class="row justify-content-center py-8 px-8 py-lg-15 px-lg-10">
                                    <div class="col-xl-12 col-xxl-10">
                                        <!--begin::Wizard Form-->
                                        <form class="form" id="kt_form" action="{{ route('admins.update', $admin->id) }}" method="POST">
                                            @csrf
                                            @method('PUT')
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-9 col-xl-9">
                                                                <input
                                                                    ...
                                                                    name="name" type="text" value="{{ $admin->name }}" placeholder="الاسم" required/>
                                                                @if ($errors->has('name'))
                                                            ...
                                                            <div class="col-lg-9 col-xl-9">
                                                                <div
                                                                    ...
                                                                    <input type="email"
                                                                        ...
                                                                        name="email" value="{{ $admin->email }}" placeholder="البريد الالكتروني" required/>
                                                                        @if ($errors->has('email'))
                                                                        <span class="invalid-feedback" role="alert">
